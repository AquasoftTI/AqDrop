...
begin
// Este método demonstra a customização de um SQL para buscar registros específicos.
// Neste caso, para demonstrar mais de uma opção, o filtro acontece através de um inner join
// e de uma condição de igualdade no where.
  Result := Get(
